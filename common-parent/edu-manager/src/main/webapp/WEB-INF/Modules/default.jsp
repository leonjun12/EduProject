...
<html>
<head>
<meta content="天霸IT教育系统" name="keywords" />
<meta content="天霸IT教育系统" name="description" />
					...
					<div class="header_tab">
						<ul>
							...
							<li><span class="header_hi">Hi,</span><span
								class="header_usename">天霸</span>！</li>
					...
					<ul id="showMainNav" class="fix">
						...
						<li class="navContent">
							<a href="#" class="showNav" id="a" data-name="main_iframe"
							   onclick="Common.switchNavigation(this);"
							   data-url="${pageContext.request.contextPath}/salary/manage.do">资金库</a>
						</li>
					</ul>
				</nav>
			</div>
